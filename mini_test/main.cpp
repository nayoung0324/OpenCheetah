...
int main()
{
    ...
    parms.set_coeff_modulus(CoeffModulus::Create(N, { 54 })); // single coeff modulus
    ...
    // ----- timing: coefficient rotation (custom mod2k) -----
    ...
    const uint64_t checksum = w_add_mod2k_orig.data(0)[0] ^ w_add_mod2k_fast.data(0)[1] ^ w_mulc_mod2k.data(0)[2] ^
                              ...
                              w_ptmul_seal.data(0)[6] ^ w_rot_mod2k.data(0)[7];
